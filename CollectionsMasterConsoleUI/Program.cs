...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"First # in array: {numbers[0]}");
            ...
            */
            ...
            Console.WriteLine($"numList Capacity: {numList.Capacity}");

            //TODO: Populate the List with 50 random numbers between 0 and 50 you will need a method for this            
            Populater(numList);

            //TODO: Print the new capacity
            Console.WriteLine($"numList new Capacity: {numList.Capacity}");
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"<waves hand> These aren't the droids you're looking for");
                Console.WriteLine("...These aren't the droids I'm looking for");
            }
        }
